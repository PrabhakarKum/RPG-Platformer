...
public class SkillObject_Crystal : SkillObject_Base
{
    ...
    public void SetupCrystal(CrystalSkill crystalSkill, float detonationTime, bool canMove, float crystalSpeed, Transform newTarget = null)
    {
        this.crystalSkill = crystalSkill;
        playerStats = crystalSkill.player.entityStats;
        damageScaleData = crystalSkill.damageScaleData;
        ...
        if(canMove)
            MoveTowardsClosestTarget(crystalSpeed, newTarget);
    }
}
