      ...
      { 
         ...
         case StatType.Intelligence:
            return "Increases elemental resistances by 0.5% per point." + 
                   ...
                   "\n If all elements have o damage, the bonus will not be applied.";
         ...
         case StatType.ArmourReduction:
            return "Percent of armour that will be ignored by your attacks.";
         ...
         case StatType.Armour:
            return "Reduces incoming physical damage."
                   + "\n armour mitigation is limited at 85%."
                   + "Current mitigation is: " + playerStats.GetArmourMitigation(0) * 100 + "%.";
